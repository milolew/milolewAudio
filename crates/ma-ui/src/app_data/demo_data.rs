//! Demo project data — sample tracks and clips for development/testing.
...
/// Create the default set of demo tracks.
pub(super) fn create_demo_tracks() -> Vec<TrackState> {
    vec![
...
/// Create demo clips with sample notes for the given tracks.
pub(super) fn create_demo_clips() -> Vec<ClipState> {
    vec![
        ClipState {
            id: ClipId(demo_id(1)),
